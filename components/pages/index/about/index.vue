    ...
    <div class="flex justify-between my-8 items-center">
      ...
      <div class="text-justify">
        <p class="py-2">
          ...
          <strong>Redux</strong>. I know <strong>SSR</strong> and frameworks
          which allow to work with it - <strong>Nuxt</strong> and
          <strong>Next</strong>. I'm fluent with <strong>CSS</strong>, tools
          related to it like <strong>SCSS</strong> or
          <strong>TailwindCSS</strong> and UI libraries such as
          <strong>Vuetify</strong> and <strong>Material UI</strong>. I also know
          basics of <strong>3D</strong> rendering in the browsers and
        ...
        <p class="py-2">
          ...
          <strong>Git</strong> for control version, <strong>Swagger</strong> for
          ...
          <strong>meet a business needs</strong>, so I'm open to learn
          everything which allows me to achieve that.
        </p>
        <p class="py-2">
          I started my profesional career in 2018, when I joined
          <strong>Webwizards</strong> - the agency working for the biggest
          ...
          <strong> Poznan University of Technology </strong> for 4 years in a
          weekend mode and I graduaded with a
        ...
        <p class="py-2">
          I love programming and I spend time for
